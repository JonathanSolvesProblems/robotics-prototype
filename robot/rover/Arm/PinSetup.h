...
#define M1_MAX_SOFT_ANGLE     270.0
...
#define M4_PWM_PIN        4
// 27&28 are A15&A16
#define M4_ENCODER_PORT    GPIOA_PDIR //!< the input register for the port connected to the encoder pins
//! \brief the position of the lower encoder pin bit. The encoder interrupt code expects this to function correctly.
...
*/
#define M5_GEAR_RATIO      27.0 // new ratio is 30.0 // worm gear
...
#define M6_GEAR_RATIO      27.0 // new ratio is 40.0
